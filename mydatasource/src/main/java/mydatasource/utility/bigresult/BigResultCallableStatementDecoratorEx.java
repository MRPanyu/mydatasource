...
public class BigResultCallableStatementDecoratorEx extends
	...
	public ResultSet executeQuery() throws SQLException {
		...
		rsd.setIndexedParameters(indexedParameters);
		rsd.setMaxParameterIndex(maxParameterIndex);
		rsd.setNamedParameters(namedParameters);
		rsd.init();
		return rsd;
	}
