...
public class ConnectionDecorator implements Connection {
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		return decoratePreparedStatement(
				delegateConnection.prepareStatement(sql), sql);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType,
			...
			throws SQLException {
		return decoratePreparedStatement(
				delegateConnection.prepareStatement(sql, resultSetType,
	...
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys)
			throws SQLException {
		return decoratePreparedStatement(
				delegateConnection.prepareStatement(sql, autoGeneratedKeys),
				sql);
	}
	...
	public PreparedStatement prepareStatement(String sql, int[] columnIndexes)
			throws SQLException {
		return decoratePreparedStatement(
				delegateConnection.prepareStatement(sql, columnIndexes), sql);
	}
	...
	public PreparedStatement prepareStatement(String sql, String[] columnNames)
			throws SQLException {
		return decoratePreparedStatement(
				delegateConnection.prepareStatement(sql, columnNames), sql);
	}
