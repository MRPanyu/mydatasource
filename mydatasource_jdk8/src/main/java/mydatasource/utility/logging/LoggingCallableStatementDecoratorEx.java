...
import mydatasource.CallableStatementDecoratorEx;

public class LoggingCallableStatementDecoratorEx extends
		CallableStatementDecoratorEx {
	...
	public ResultSet executeQuery() throws SQLException {
		...
		LoggingUtils.log(logger, myDataSource, sql, indexedParameters,
				maxParameterIndex, namedParameters, executeTime);
		return rs;
	}
	...
	public void addBatch(String sql) throws SQLException {
		...
		batchedNamedParameters.add(new HashMap<String, Object>());
	}
	...
	public int[] executeBatch() throws SQLException {
		...
		long executeTime = System.currentTimeMillis() - begin;
		LoggingUtils.logBatch(logger, myDataSource, batchedSqls,
				batchedIndexedParameters, batchedMaxParameterIndex,
				batchedNamedParameters, executeTime);
		return returnValue;
	}
